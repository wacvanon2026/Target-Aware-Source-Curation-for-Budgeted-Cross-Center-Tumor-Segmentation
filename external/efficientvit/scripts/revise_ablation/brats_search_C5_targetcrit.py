...
TEMPLATE_YAML = PROJECT_ROOT / 'configs_TAVO/configs_C5_cma/template.yaml'
SCORE_ROOT = PROJECT_ROOT / 'data/TAVO/splits_C5_mix_scores_multi'
SPLIT_ROOT = PROJECT_ROOT / 'data/fusion_ablation/brats21/C5_stageA2'
OUT_ROOT = PROJECT_ROOT / 'outputs_fusion_ablation/brats21/C5_stageA2'
T = 50
...
def maybe_set_warmup(cfg, ckpt_path):
    ...
    return cfg
WARMUP_CKPT = 'external/efficientvit/outputs_TAVO/outputs_C5/baseline3_brats21_source_plus_target/best_last.pt'
