...
TEMPLATE_YAML = PROJECT_ROOT / 'configs_TAVO/configs_TCGA_LGG_cma/template.yaml'
SCORE_ROOT = PROJECT_ROOT / 'data/TAVO/splits_TCGA_LGG_mix_scores_multi'
SPLIT_ROOT = PROJECT_ROOT / 'data/fusion_ablation/brats21/TCGA_LGG_stageA2'
OUT_ROOT = PROJECT_ROOT / 'outputs_fusion_ablation/brats21/TCGA_LGG_stageA2'
T = 50
...
def maybe_set_warmup(cfg, ckpt_path):
    ...
    return cfg
WARMUP_CKPT = 'external/efficientvit/outputs_TAVO/outputs_TCGA_LGG/baseline3_brats21_source_plus_target/best_last.pt'
