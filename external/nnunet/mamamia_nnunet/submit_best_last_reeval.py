#!/usr/bin/env python3
"""Submit best-last checkpoint re-evaluation jobs for completed MAMAMIA rows."""
    ...
    for target in args.targets:
        for experiment in args.experiments:
            ...
            cmd = [
                ...
                (
                    "--export="
                    f"ALL,FORCE=1,BEST_LAST_WINDOW={args.window},"
                    "CLEAN_PREPROCESSED_ON_SUCCESS=0,CLEAN_PREPROCESSED_ON_ERROR=0"
                ),
                str(script),
                target,
                experiment,
