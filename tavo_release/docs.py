...
KNOWN_COMMANDS = {'check', 'collect', 'command', 'da-command', 'da-config', 'docs-audit', 'download', 'matrix', 'officehome-config', 'pathway-audit', 'plan', 'plan-audit', 'route-audit', 'route-inventory', 'repro-smoke', 'search', 'select', 'selection-route', 'smoke', 'split', 'tavo-command'}
